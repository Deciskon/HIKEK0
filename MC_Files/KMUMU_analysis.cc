...
void KMUMU_analysis::InitHist() {
    ...
    BookHisto(new TH1F("Reco_Pplus", "Reconstructed #mu^{+} Momentum Distribution;P_{#mu^{+}} [GeV/c];Count", 600, 0, 300));
    BookHisto(new TH1F("Reco_Pminus", "Reconstructed #mu^{-} Momentum Distribution;P_{#mu^{-}} [GeV/c];Count", 600, 0, 300));
    ...
    BookHisto(new TH2F("Reco_muplus_xy_straw1", "Reconstructed #mu^{+} XY Plane;X_{STRAW1} [mm]; Y_{STRAW1} [mm]", 1500 , -1500, 1500,1500 , -1500, 1500));
    BookHisto(new TH2F("Reco_muminus_xy_straw1", "Reconstructed #mu^{-} XY Plane;X_{STRAW1} [mm]; Y_{STRAW1} [mm]", 1500 , -1500, 1500,1500 , -1500, 1500));
    BookHisto(new TH2F("Reco_muplus_only_xy_straw1", "Reconstructed #mu^{+} ONLY XY Plane;X_{STRAW1} [mm]; Y_{STRAW1} [mm]", 1500 , -1500, 1500,1500 , -1500, 1500));
    BookHisto(new TH2F("Reco_muminus_only_xy_straw1", "Reconstructed #mu^{-} ONLY XY Plane;X_{STRAW1} [mm]; Y_{STRAW1} [mm]", 1500 , -1500, 1500,1500 , -1500, 1500));
    BookHisto(new TH2F("Reco_plus_vs_minus_Rstraw1", "Reconstructed Radial Distance of- #mu^{-} vs #mu^{+};R_{STRAW1 q=-1} [mm]; R_{STRAW1 q=1} [mm]", 1500 , 0, 1500,1500 , 0, 1500));
    ...
    BookHisto(new TH1F("Reco_geom_Pplus", "Reconstructed #mu^{+} Momentum Distribution;P_{#mu^{+}} [GeV/c];Count", 600, 0, 300));
    BookHisto(new TH1F("Reco_geom_Pminus", "Reconstructed #mu^{-} Momentum Distribution;P_{#mu^{-}} [GeV/c];Count", 600, 0, 300));
    ...
    BookHisto(new TH2F("Reco_geom_dPplus_vs_Pplus_true", "True #mu^{+} Momentum vs Difference in Reco and True #mu^{+} Momentum;P_{#mu^{+} true} [GeV/c];P_{#mu^*{+} reco} - P_{#mu^{+} true} [GeV/c]", 800, 0, 400, 800, -50,50));
    BookHisto(new TH2F("Reco_geom_dPminus_vs_Pminus_true", "True #mu^{-} Momentum vs Difference in Reco and True #mu^{-} Momentum;P_{#mu^{-} true} [GeV/c];P_{#mu^*{-} reco} - P_{#mu^{-} true} [GeV/c]", 800, 0, 400, 1000, -10,10));
    BookHisto(new TH2F("Reco_geom_dTheta_minus_vs_Theta_minus_true", "True #mu^{-} Angle vs Difference in Reco and True #mu^{-} Angle;#Theta_{#mu^{-} true} [rad];#Theta_{#mu^{-} reco} - #Theta_{#mu^{-} true} [rad]", 1000, 0,0.02, 1000, -0.001,0.001));
    BookHisto(new TH2F("Reco_geom_dTheta_minus_vs_Pminus_true", "True #mu^{-} Momentum vs Difference in Reco and True #mu^{-} Angle;P_{#mu^{-} true} [GeV/c];#Theta_{#mu^{-} reco} - #Theta_{#mu^{-} true} [rad]", 800, 0, 400, 1000, -0.001,0.001));
    BookHisto(new TH2F("Reco_geom_dTheta_plus_vs_Theta_plus_true", "True #mu^{+} Angle vs Difference in Reco and True #mu^{+} Angle;#Theta_{#mu^{+} true} [rad];#Theta_{#mu^{+} reco} - #Theta_{#mu^{+} true} [rad]", 1000, 0,0.02, 1000, -0.001,0.001));
    BookHisto(new TH2F("Reco_geom_dTheta_plus_vs_Pplus_true", "True #mu^{+} Momentum vs Difference in Reco and True #mu^{+} Angle;P_{#mu^{+} true} [GeV/c];#Theta_{#mu^{+} reco} - #Theta_{#mu^{+} true} [rad]", 800, 0, 400, 1000, -0.001,0.001));

    BookHisto(new TH1I("Reco_geom_NKineParts", "Number of KineParts Distribution;KineParts;Count", 10, -0.5, 9.5));
    BookHisto(new TH1I("Reco_geom_Nmudecays_before_straw4", "Number of Decays Before Each Straw Distribution;Decays Before Straw(x+1);Count", 3, -0.5, 2.5));
    ...
    BookHisto(new TH1F("Reco_final_Pplus", "Reconstructed #mu^{+} Momentum Distribution;P_{#mu^{+}} [GeV/c];Count", 600, 0, 300));
    BookHisto(new TH1F("Reco_final_Pminus", "Reconstructed #mu^{-} Momentum Distribution;P_{#mu^{-}} [GeV/c];Count", 600, 0, 300));
    ...
    BookHisto(new TH2F("Reco_geom_posstraw1_plus_vs_minus", "Posstraw1: mu+ vs mu-;posstraw1_plus;posstraw1_minus", 1500, -1500, 1500, 1500, -1500, 1500));
    ...
    BookHisto(new TH1F("Reco_final_tauks", "Reconstructed #tau_{K_{S}} Distribution;t_reco [#tau_{K_{S} reco}];Count", 240, 0, 60));
    BookHisto(new TH1F("Prod_tauks_true", "True #tau_{K_{S}} Distribution;t_true [#tau_{K_{S} true}];Count", 240, 0, 60));
}
...
void KMUMU_analysis::Process(int iEvent) {
    ...
    while(partit_all.Next()) {  // itterate through ALL particles
        ...
        if(particle->GetPDGcode() == -13) {  // mu+
            //fTp = particle->GetFinal4Momentum();
        }
        if(particle->GetPDGcode() == 13) {  // mu-
           //fTm = particle->GetFinal4Momentum();
        }
        //if((particle->GetPDGcode() == 211) || (particle->GetPDGcode() == -211)) return;
    ...
    FillHisto("Prod_tauks_true", tau_ks_true*gamma_K_true);
    ...
    for (int iT(0); iT < fSpectrometerEvent->GetNCandidates();iT++){
        ...
        if(pT->GetCharge()==1){
            ...
            fTp = GetTrack(pT,MMU/1000.0);
            fSplus  = pT;
        }
        if(pT->GetCharge()==-1){
            FillHisto("Reco_Pminus", pT->GetMomentum()/1000.0);

            fTm = GetTrack(pT,MMU/1000.0);
            fSminus  = pT;
        }
    }
   ...
   if(qvertex == 1)
   {
    ...
    FillHisto("Reco_muplus_only_xy_straw1" , posstraw1_plus_only.X(), posstraw1_plus_only.Y());
   }
   ...
   if(qvertex == -1)
   {
    ...
    FillHisto("Reco_muminus_only_xy_straw1", posstraw1_minus_only.X(), posstraw1_minus_only.Y());
   }
   ...
   if(qvertex == 0) 
   {
    ...
    FillHisto("Reco_muplus_xy_straw1" , posstraw1_plus.X(), posstraw1_plus.Y());
    FillHisto("Reco_muminus_xy_straw1", posstraw1_minus.X(), posstraw1_minus.Y());
    ...
    int nmudec_bstraw4 = 0; // straw 1,2,3,4 = [212.9, 219.5, 229.8, 236.8] m
    ...
    FillHisto("Reco_geom_Nmudecays_before_straw4", nmudec_bstraw4);
    ...
    FillHisto("Reco_final_tauks", tau_ks);
